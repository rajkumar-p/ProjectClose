...
func makeLeadDetailsPagingViewController(leadId: String, mainNavigationController: UINavigationController) -> LeadDetailsPagingMenuViewController {
    ...
    struct PagingMenuOptions: PagingMenuControllerCustomizable {
        ...
        init(mainNavigationController: UINavigationController) {
            leadTasksTableViewController = LeadTasksTableViewController(mainNavigationController: mainNavigationController)
            
            leadOpportunitiesTableViewController = LeadOpportunitiesTableViewController()
            leadContactsTableViewController = LeadContactsTableViewController()
            leadMessagesTableViewController = LeadMessagesTableViewController()
            leadStatusTableViewController = LeadStatusTableViewController()
        }
    ...
    return LeadDetailsPagingMenuViewController(options: PagingMenuOptions(mainNavigationController: mainNavigationController), leadId: leadId, mainNavigationController: mainNavigationController)
}
